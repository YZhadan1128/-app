...
<!-- 引用iconfont的图标，需全局iconfont.css --> 
<!-- 
全局css下，移动端 woff+ttf 或 直接ttf(安卓4.3-使用ttf)
.@font-face {
	font-family: "iconfont";
	src: url("fonts/iconfont.woff") format("woff"), url("fonts/iconfont.ttf") format("truetype");
}
html使用
<i class="iconfont iconfont-logout"></i>
 --> 
<cmd-icon prefix-class="iconfont" type="logout" size="30" color="#654321"></cmd-icon>
```
